...
const Hero = () => {
  return (
    ...
    <div className="flex flex-col items-start text-center md:text-left order-2 md:order-1 mt-10 md:mt-0">
      ...
      {/* Chat-like styling */}
      <div className="speech-bubble">⛁ I love databases (I normalize them for fun)</div>
      <div className="speech-bubble">⚙️🛠️🧩💻 I’m a backend API guru (I’m pretty good at building them, and building them fast)</div>
      <div className="speech-bubble">⚛️🎨🖥️ I do frontend too (No interface is too hard for me to build)</div>
      <div className="speech-bubble">👨🏿‍💻📲💻🧠 I love building apps that solve everyday problems (Some are still in development)</div>
